...
<template>
  <div class="prime-wrap" style="margin-top: 80px">
    <div class="main01">
      ...
      />
      <img
        class="prime_sticker2"
        src="/prime/prime_sticker02.png"
        alt="뱃지2"
      />

      <div class="prime_main_txt_box">
        <p style="font-size: 80px; font-weight: 500; color: #1456fd">
          빙 프 라 임
        </p>
    ...
    <div class="prime_txt">
      ...
      >
        ...
        <span style="color: #02123a"
          >지금 <b style="font-weight: 600">빙프라임</b> 가입하고
          <b style="font-weight: 600">멤버스 라운지</b>를 이용해 보세요.</span
        >
      </p>
      <hr
        style="
      ...
      <p
        ...
        "
      >
        빙프라임 멤버스 라운지에서는 프리몰부터 빙프리에서 운영하는 실험 연구소
        체험까지
        <br />
        ...
        >
          ...
          <tbody style="font-size: 48px; background-color: #fff">
            <tr>
              ...
              >
                가입 즉시
                <strong style="color: #1456fd; font-weight: 600"
                  >3,000원</strong
                >
                포인트 적립
              </td>
        ...
        <div class="box_top">
          ...
          <div class="top_left">
            <div class="bar">
              <p
                class="main-h3"
                style="color: #e9ff54; letter-spacing: 7px; font-weight: 300"
              >
...
.main02 {
  ...
  .main02_img {
    ...
    &.anim_active::before {
      animation: ani_opacity 1.6s 0.5s ease-in-out forwards,
        ani_move2 1.6s 0.5s ease-in-out;
    }
    .img_txt {
      display: flex;
      gap: 28px;
