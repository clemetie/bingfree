...
<template>
  ...
  <!-- 비주얼 스와이프 -->
  <div class="visual" :class="{ scroll: isScrolled }">
      ...
      <div class="main-introBing-txt">
        ...
        <div id="main-introBing-txt-sub" class="main-h4">
          <p>
            ...
            <span style="color: #1456fd">최소 일주일에 한번, 정기적인 관리</span
            >가 필요합니다.
          </p>
          <p>
          ...
          <p>
            보이는게 다가 아닙니다. 제빙기 내부
            <span style="color: #1456fd">수많은 물 곰팡이들</span>, 본체
            전까지는 모릅니다.
          </p>
          <p>
            더러운 얼음으로
        ...
        <div class="review-box">
          ...
          <div class="review-customer">
            <img
              ...
              alt="스타벅스 아이콘"
            />
            <p style="font-size: 15px; font-weight: 700; color: #424242">
              스타벅스 중앙로점
            </p>
          </div>
        </div>
